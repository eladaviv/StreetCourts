...
public class EditFragmentDirections {
  private EditFragmentDirections() {
  }

  @NonNull
  public static NavDirections actionEditFragmentToMemberListRvFragment() {
    return new ActionOnlyNavDirections(R.id.action_editFragment_to_memberListRvFragment);
  }

  @NonNull
  public static ActionEditFragmentToMemberDetailsFragment actionEditFragmentToMemberDetailsFragment(
      @NonNull String memberId, @Nullable String currMemberId) {
    return new ActionEditFragmentToMemberDetailsFragment(memberId, currMemberId);
  }
  ...
  public static class ActionEditFragmentToMemberDetailsFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    @SuppressWarnings("unchecked")
    private ActionEditFragmentToMemberDetailsFragment(@NonNull String memberId,
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionEditFragmentToMemberDetailsFragment setMemberId(@NonNull String memberId) {
      if (memberId == null) {
        throw new IllegalArgumentException("Argument \"memberId\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("memberId", memberId);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionEditFragmentToMemberDetailsFragment setCurrMemberId(
        @Nullable String currMemberId) {
      this.arguments.put("currMemberId", currMemberId);
      return this;
    }
    ...
    public int getActionId() {
      return R.id.action_editFragment_to_memberDetailsFragment;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionEditFragmentToMemberDetailsFragment that = (ActionEditFragmentToMemberDetailsFragment) object;
    ...
    public String toString() {
      return "ActionEditFragmentToMemberDetailsFragment(actionId=" + getActionId() + "){"
