...
public class MemberDetailsFragmentDirections {
  private MemberDetailsFragmentDirections() {
  }

  @NonNull
  public static ActionMemberDetailsFragmentToEditFragment actionMemberDetailsFragmentToEditFragment(
      @NonNull String memberId, @NonNull String currMemberId) {
    return new ActionMemberDetailsFragmentToEditFragment(memberId, currMemberId);
  }
  ...
  public static class ActionMemberDetailsFragmentToEditFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    @SuppressWarnings("unchecked")
    private ActionMemberDetailsFragmentToEditFragment(@NonNull String memberId,
        @NonNull String currMemberId) {
      if (memberId == null) {
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionMemberDetailsFragmentToEditFragment setMemberId(@NonNull String memberId) {
      if (memberId == null) {
        throw new IllegalArgumentException("Argument \"memberId\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("memberId", memberId);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionMemberDetailsFragmentToEditFragment setCurrMemberId(@NonNull String currMemberId) {
      if (currMemberId == null) {
        throw new IllegalArgumentException("Argument \"currMemberId\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("currMemberId", currMemberId);
    ...
    public int getActionId() {
      return R.id.action_memberDetailsFragment_to_editFragment;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionMemberDetailsFragmentToEditFragment that = (ActionMemberDetailsFragmentToEditFragment) object;
    ...
    public String toString() {
      return "ActionMemberDetailsFragmentToEditFragment(actionId=" + getActionId() + "){"
