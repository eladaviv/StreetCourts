...
public class PostFragmentDirections {
  ...
  @NonNull
  public static ActionPostFragmentToMemberDetailsFragment actionPostFragmentToMemberDetailsFragment(
      @NonNull String memberId, @Nullable String currMemberId) {
    return new ActionPostFragmentToMemberDetailsFragment(memberId, currMemberId);
  }
  ...
  public static class ActionPostFragmentToMemberDetailsFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    @SuppressWarnings("unchecked")
    private ActionPostFragmentToMemberDetailsFragment(@NonNull String memberId,
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionPostFragmentToMemberDetailsFragment setMemberId(@NonNull String memberId) {
      if (memberId == null) {
        throw new IllegalArgumentException("Argument \"memberId\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("memberId", memberId);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionPostFragmentToMemberDetailsFragment setCurrMemberId(
        @Nullable String currMemberId) {
      this.arguments.put("currMemberId", currMemberId);
      return this;
    }
    ...
    public int getActionId() {
      return R.id.action_postFragment_to_memberDetailsFragment;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionPostFragmentToMemberDetailsFragment that = (ActionPostFragmentToMemberDetailsFragment) object;
    ...
    public String toString() {
      return "ActionPostFragmentToMemberDetailsFragment(actionId=" + getActionId() + "){"
