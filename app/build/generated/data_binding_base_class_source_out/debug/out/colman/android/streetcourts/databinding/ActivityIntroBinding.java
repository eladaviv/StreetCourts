...
public final class ActivityIntroBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView introImgv;

  private ActivityIntroBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView introImgv) {
    this.rootView = rootView;
    this.introImgv = introImgv;
  }
  ...
  public static ActivityIntroBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.intro_imgv;
      ImageView introImgv = ViewBindings.findChildViewById(rootView, id);
      if (introImgv == null) {
        break missingId;
      }

      return new ActivityIntroBinding((ConstraintLayout) rootView, introImgv);
    }
